...
\newcommand{\hmwkDueDate}{September 12, 2018}
\newcommand{\hmwkClass}{Stat 5120}
\newcommand{\hmwkClassTime}{Section 001}
\newcommand{\hmwkClassInstructor}{Professor  Chao DU }
\newcommand{\hmwkAuthorName}{\textbf{Ryan Sanders} }
...
\title{
	...
	\normalsize\vspace{0.1in}\small{Due\ on\ \hmwkDueDate\ at 4 pm}\\
...
\begin{document}
	...
	\begin{homeworkProblem}
		...
		\textbf{Part (a)} Based in Figure~\ref{fig:FareAgainstData}, a simple linear regression appears to be reasonable for the data. 
		\begin{figure}
			\includegraphics[width=\linewidth]{FareAgainstData.jpg}
			\caption{A graph.}
%			\label{fig:FareAgainstData}
		\end{figure}
		
		Figure \ref{fig:FareAgainstData} shows a graph.
		% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
		% Date and time: Sun, Sep 09, 2018 - 11:46:06
		\begin{table}[!htbp] \centering 
			\caption{Regression Results} 
			\label{{Problem1RegressionResults}} 
			\begin{tabular}{@{\extracolsep{5pt}}lc} 
				...
				R$^{2}$ & 0.994 \\ 
				Adjusted R$^{2}$ & 0.994 \\ 
				Residual Std. Error & 10.412 (df = 15) \\ 
				F Statistic & 2,469.296$^{***}$ (df = 1; 15) \\ 
				\hline 
				\hline \\[-1.8ex] 
		...
		\textbf{Part (b)}
		The estimated equation for the linear regression 
			\begin{equation}
		...
		with estimated slope \(\hat{\beta_1} = 0.220\) and constant\(\hat{\beta_0} = 0.48.972\)  .
		\\
		
		\textbf{Part (c)}
		The coefficient of determination, \(R^2 = 0.994\), suggests a high degree of  correlation against Cost of Fare and Distance Traveled.
		
		\textbf{Part (d)}
		The estimated correlation coefficient, \(R^2 = 0.997\), suggests a high degree of positvie colinearity against Cost of Fare and Distance Traveled.
		
		\textbf{Part (e)}
		Based on the Standard Error shown in Table~\ref{Problem1RegressionResults}, \(	\hat{\sigma} =10.42\), gives \(		\hat{\sigma^2} = 108.58\).
	\end{homeworkProblem}
